...
<title> Malden Hollywood Cinema - The Menu </title>
</head> 

<h1 class="titleHeading"> The Menu </h1> 

<img src="../images/the_menu_poster.jpg" width="200" height="300" />
</br>
...
<form class="rightButton" action="../controller/seatsFour.php"> 
