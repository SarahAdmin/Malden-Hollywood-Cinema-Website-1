...
<div><a href="../controller/seatsOne.php" onclick="seatSelected()" name="seatId" class="selectedSeat"><?= $anySeat->SEAT_CODE ?></a></div>
<?php endforeach ?>
...
<form class="leftButton" action="../controller/film1.php"> 
