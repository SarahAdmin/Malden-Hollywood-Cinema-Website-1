<html> 
    <body> 
        ...
        <script src="../javascript/quantity.js"></script>
            <title> Malden Hollywood Cinema - Avatar: The Way of Water </title>
</head> 

<h1 class="titleHeading">  Malden Hollywood Cinema - Avatar: The Way of Water </h1> 

<img src="../images/Avatar_poster.jpg" width="200" height="300" />
</br>
...
<form class="rightButton" action="../controller/seatsSeven.php">
